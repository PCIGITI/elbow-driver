...
ROLL_RADIUS = 10/2 # mm, radius of the roll capstan
CAPSTAN_RADIUS = 15.3/2 # mm, radius of the capstan on the motor
MOTOR_STEPS_PER_REVOLUTION = 1600*2# steps per revolution (of the capstan/motor)

def get_steps(curr_theta, delta_theta, latest_dir): # curr_theta is often unused for simple roll but kept for API consistency
